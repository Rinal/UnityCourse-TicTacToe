...
{
    public abstract class BaseValueAsyncPresenter<TTarget> : BasePresenter
        where TTarget : struct
    {
        ...
        public virtual IObservable<Unit> Show(TTarget target)
        {
            Target = target;
            m_isOpen.Value = true;
            m_onShow.Invoke();
    ...
    public abstract class BaseValueAsyncPresenter<TTarget1, TTarget2> : BasePresenter
        where TTarget1 : struct
        where TTarget2 : struct
    {
        [SerializeField] private UnityEvent m_onShow = new UnityEvent();
        private readonly BoolReactiveProperty m_isOpen = new BoolReactiveProperty(false);
        public override IReadOnlyReactiveProperty<bool> IsOpen => m_isOpen;
        ...
        public virtual IObservable<Unit> Show(TTarget1 target1, TTarget2 target2)
        {
            Target1 = target1;
            Target2 = target2;
            m_isOpen.Value = true;
