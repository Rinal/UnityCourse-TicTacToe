...
{
    public abstract class BaseReferenceAsyncPresenter<TTarget> : BasePresenter
        where TTarget : class
    {
    ...
    public abstract class BaseReferenceAsyncPresenter<TTarget1, TTarget2> : BasePresenter
